/**
 * Playwright fixture that boots the mock Yandex Alice page with a JS mock of
  ...
  return `
    (function () {
      ...
      window.AndroidBridge = {
        ...
        getAssetUrl(path) {
          return "https://bap-asset.local/bds/" + (path || "");
        },
        fetch(payloadJson) {
          let payload = {};
...
export const test = base.extend({
  context: async ({ browser }, use) => {
    ...
    // resolves bap-platform-globals to globals-android.js. The page sees
    ...
    // (window.__mockYandex Alice) initialize first — same ordering the Android
        ...
        (function () {
          document.addEventListener("DOMContentLoaded", function () {
            try {
              ...
              console.error("[bap-Android sim] content.js failed:", err);
            }
          });
        })();
      `,

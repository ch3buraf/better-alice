...
> Расширение **не публиковалось** в Chrome Web Store / Firefox Add-ons / Edge Add-ons — просто лень было заморачиваться с подачей. Если хотите опубликовать — pull request приветствуется, или форк под вашим аккаунтом, я не против.

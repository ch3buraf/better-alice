...
<aside id="bap-drawer" class={open ? "bap-open" : "bap-closed"}>
  <div class="bap-drawer-header">
    <div class="ds-modal-content__title">Better Alice</div>
    <button id="bap-close" type="button" onclick={onclose} aria-label="Close">
  ...
  {:else}
    ...
    <div class="bap-drawer-footer">
      <a href="https://github.com/" target="_blank" rel="noopener noreferrer" class="bap-github-link">
        ...
        <span>GitHub <small style="opacity: 0.6; font-weight: 400; margin-left: 4px;">v0.1.0</small></span>
      </a>
    </div>
  {/if}
</aside>

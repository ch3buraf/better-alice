...
const state = {
  ...
  pricing: {
    ...
    /** @type {Map<string, {inputTokens:number,outputTokens:number,inputCost:number,outputCost:number,totalCost:number}>} per-message token/cost data (keyed by message node's bap-price-id) */
    messageData: new Map(),
